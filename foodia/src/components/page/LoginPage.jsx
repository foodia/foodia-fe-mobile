        ...
        <div className="container mx-auto mt-24 bg-white h-96 text-primary">
            ...
            <form className='p-2 mt-20' >
                ...
                <div className="flex items-start mb-4">
                    ...
                    <label htmlFor="remember" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Forgot password?</label>
                </div>
                <div className=" grid gap-4 content-center">
                    <button onClick={handleSubmit} type="submit" className="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Log In</button>
                </div>
                <div className=" grid gap-4 content-center mt-2">
                    <Link href={register} className="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center ">{Btn}</Link>
                </div>
            </form>

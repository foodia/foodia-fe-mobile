...
const AddFoodCamp = ({ id, name, price, imageUrl, store, description, capacity, addToCart }) => {
        ...
        <div className="w-full bg-white hover:bg-gray-200 text-black border border-black-1 rounded-lg inline-flex items-center px-4 py-2.5 mt-4">
            <div className="flex justify-between w-full">
                <div className="flex">
                    ...
                    <img className="w-10 h-10 rounded-full bg-blue-100 grid place-items-center mr-2 text-blue-600" src={imageUrl} alt="" />
